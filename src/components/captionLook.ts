 ...
 */
export const CONTENT_CAPTION_STYLES = new Set(["chat", "social", "quiz", "ranking", "book", "storybook", "pen", "recipe", "terminal", "luxury", "podcast", "blueprint", "watercolor", "liveshop", "karaoke", "lyrics", "vinyl"]);
