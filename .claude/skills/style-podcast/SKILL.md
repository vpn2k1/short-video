...
- **Thẻ tập** bo góc 48px, nền kem trong suốt 4–8%, viền mảnh, bóng sâu. Trong thẻ từ trên xuống:
  đầu thẻ (ô micro gradient màu nhấn · "PODCAST · TẬP n" đậm · viên "● ĐANG PHÁT" đỏ, chấm nhấp nháy) →
...
- **Thẻ trích dẫn**: dấu “ Playfair Display 900 màu nhấn trồi khỏi mép trên, lời trích Be Vietnam Pro 700 cỡ lớn,
  gạch màu nhấn + tên người nói ở chân thẻ (khi `tag` có tên).
...
| Trường | Cách vẽ |
|---|---|
| `image` | Ảnh/clip trong khung bo góc, phóng chậm 1.03 → 1.10 suốt cảnh, tối dần ở đáy. Video phát trong khung, tắt tiếng, lặp. Sang cảnh ảnh mới hoà đè lên ảnh cũ 12 frame. `null` → ảnh đại diện tròn màu nhấn có **micro trắng**, ba vòng sóng lan ra to hơn khi đang nói. |
...
| `tag` | Bảng tên ở góc dưới trái khung ảnh, vạch màu nhấn bên trái. Dạng "Nhãn: Tên" ("Khách mời: BS. Minh Anh") tách thành nhãn in hoa nhỏ + tên lớn, và tên đó thành chữ ký dưới lời trích; không có dấu ":" ("Phần 2") thì một dòng. Không có tên trong tag → không có chữ ký. |
...
| `title`/`subtitle` | Khi `showTitle`: ô bìa podcast vuông (ảnh cảnh đầu tiên có ảnh, ám màu nhấn; không có thì gradient) với "PODCAST · TẬP n", vòng sóng đồng tâm, tiêu đề lớn, dòng phụ; dưới bìa nút "▶ Nghe ngay" + hàng sóng nhỏ + dòng "TẬP MỚI · MỜI BẠN NGHE". |
...
- Ảnh: chân dung người nói nhìn nghiêng/nói chuyện, micro phòng thu, bối cảnh talkshow; cảnh không ảnh sẽ thành ảnh đại diện micro + sóng âm (hợp với đoạn chỉ có giọng).
