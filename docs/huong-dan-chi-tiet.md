...
Tài liệu tham khảo cho người dùng kỹ và người phát triển: từng màn hình của giao diện web, dòng lệnh,
cách pipeline hoạt động, cấu trúc thư mục, giới hạn đã đo. Cài đặt và chạy app: xem [README](../README.md).

---

## Mục lục

1. [Giao diện web](#1-giao-diện-web)
2. [Dòng lệnh](#2-dòng-lệnh)
3. [Cách hoạt động](#3-cách-hoạt-động)
4. [Cấu trúc thư mục](#4-cấu-trúc-thư-mục)
5. [Giới hạn đã đo](#5-giới-hạn-đã-đo)
...
Tài liệu chi tiết hơn về pipeline: [docs/prompt-to-video.md](prompt-to-video.md).
Đọc code và bảo trì dự án (đọc gì trước, sửa một thứ phải đụng đâu, bẫy đã gặp, phát hành): [docs/bao-tri-du-an.md](bao-tri-du-an.md).
AI viết kịch bản chạy trên máy (có sẵn trong app, hoặc Ollama): [docs/ai-tren-may.md](ai-tren-may.md).
